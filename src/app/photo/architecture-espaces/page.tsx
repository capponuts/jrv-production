  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <div className="text-center py-2">
        <h1 className="text-3xl md:text-4xl font-bold">Architecture & Espaces</h1>
        <p className="text-gray-600 mt-2">Des images qui subliment vos lieux, captées avec soin pour donner envie d&apos;y être</p>
      </div>
