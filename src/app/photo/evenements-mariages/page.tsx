  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <div className="text-center py-2">
        <h1 className="text-3xl md:text-4xl font-bold">Événements & Mariages</h1>
        <p className="text-gray-600 mt-2">Capturer vos instants précieux, des cérémonies intimes aux grands rassemblements festifs</p>
      </div>
