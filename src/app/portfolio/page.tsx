...
export default function PortfolioPage() {
  ...
  useEffect(() => {
    const load = async () => {
      try {
        const res = await fetch('/api/photos/portfolio')
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white overflow-hidden">
      ...
      <div className="text-center py-6">
        <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-slate-400 to-gray-600 bg-clip-text text-transparent">Portfolio</h1>
        <p className="text-gray-300 mt-2">Sélection de projets et d’images représentatives</p>
      </div>
