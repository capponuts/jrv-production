...
export default function FilmsEvenementielsPage() {
  ...
  // Vidéos pour films événementiels
  const videos = [
    {
      id: 'event-1',
    ...
    },
    {
      ...
      description: 'Célébration des années de bonheur partagé',
    ...
    },
    {
      ...
      description: 'Moments sacrés et familiaux précieux',
      thumbnail: 'https://images.unsplash.com/photo-1465495976277-4387d4b0b4c6?w=1200&h=800&fit=crop',
      duration: '4:15'
    },
    {
      id: 'event-4',
      title: 'Événement corporate',
      description: 'Captation professionnelle d\'événements d\'entreprise',
    ...
    },
    {
      ...
      thumbnail: 'https://images.unsplash.com/photo-1530103862676-de8c9debad1d?w=1200&h=800&fit=crop',
      duration: '4:30'
    },
    {
      id: 'event-7',
      ...
      thumbnail: 'https://images.unsplash.com/photo-1511795409834-ef04bbd61622?w=1200&h=800&fit=crop',
      duration: '5:15'
    },
    {
      id: 'event-8',
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black text-white overflow-hidden">
      ...
      <div className="text-center py-6">
        <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-pink-400 to-rose-600 bg-clip-text text-transparent">
          Films événementiels
        </h1>
        <p className="text-gray-300 mt-2">
          Vidéos de mariages, anniversaires et événements spéciaux
        </p>
      </div>
